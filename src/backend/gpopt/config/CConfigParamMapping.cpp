...
CConfigParamMapping::SConfigMappingElem CConfigParamMapping::m_elem[] =
{
		...
		false, // m_fNegate
		GPOS_WSZ_LIT("Always pick multistage aggregates when such a plan is generated by optimizer.")
		},
		...
		{
		EopttraceForceScalarDQAMultiStageAgg,
		&optimizer_force_scalar_dqa_multistage_agg,
		false, // m_fNegate
		GPOS_WSZ_LIT("Always pick multistage aggregates for scalar distinct qualified aggregate in the optimizer.")
		},
